...
int main(int argc, char *argv[]) {
    ...
    if (db){
        ...
        for (int i = 0; i < size; ++i){ // process all the student records in database
            ...
            ////////////////////////////////////////////////////////////////////
            //Shouldnt courses not repeat?
            int checkCalc = 0;
            int checkAlgeb = 0;
            char algebStr[8] = "Algebra";
            char calcStr[9] = "Calculus";
            //check if student has the required courses
            for (int i = 0; i < s.load; ++i)
            {
                if (strcmp(s.courses[i], calcStr) == 0)
                {
                  checkCalc = 1;
                }
                else if (strcmp(s.courses[i], algebStr) == 0)
                {
                  checkAlgeb = 1;
                }
            }
            ////////////////////////////////////////////////////////////////////
            if((checkCalc) && (checkAlgeb)){ // *** first filter, conditions on the student
